        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id = "userCue">新增生鲜种类</div>
                    <div class="panel-body">
                        <form action="category" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <input type="hidden" name="method" value="addCategory">
                                <label for="category" class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-5">
                                    <input type="text" id="category" name="c_name" class="form-control" placeholder="生鲜名称">
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" id="reg" class="btn btn-primary">提交</button>
                                </div>
                            </div>
                        </form>
